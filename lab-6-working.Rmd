...
- K-function: consideres how close all neighboring objects are to an event
```{r}
...
#Need to compare to csr scenario = #gfunction#theo. Run together. Observation line is "higher"than theoretical = more clustered than csr.
